...
public class SwiftAppSignaturePlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "app_signature", binaryMessenger: registrar.messenger())
    let instance = SwiftAppSignaturePlugin()
